...
Помимо равномерного и нормального распределений, модуль `numpy.random` содержит инструмены для получения выборок из множества других дискретных и непрерывных распределений. Полный списко доступен в [документации](https://docs.scipy.org/doc//numpy-1.16.0/reference/routines.random.html).
...
Модуль `numpy.linalg` расширяет содержит различные алгоритмы линейной алгебры, например:
